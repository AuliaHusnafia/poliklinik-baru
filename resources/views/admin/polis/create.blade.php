    ...
    <div class="card-modern">
        <div class="card-header-modern">
            <div class="card-title-modern">
                ...
                <span>Tambah Unit Poli Baru</span>
            </div>
            ...
            <form action="{{ route('admin.polis.store') }}" method="POST">
                ...
                <div class="form-group-modern" style="margin-bottom: 24px;">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Masukkan nama poli (contoh: Poli Mata)" 
                           value="{{ old('nama_poli') }}" 
                           required>
                    @error('nama_poli')
                ...
                <div class="form-group-modern" style="margin-bottom: 30px;">
                    ...
                    <textarea name="keterangan" 
                              ...
                              placeholder="Tuliskan deskripsi atau informasi tambahan mengenai unit poli ini..." 
                ...
                <div style="display: flex; align-items: center; gap: 15px; padding-top: 20px; border-top: 1px solid #f1f5f9;">
                    <button type="submit" class="btn-primary-modern" style="padding: 12px 28px; font-size: 0.9rem;">
